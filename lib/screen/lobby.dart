...
class _LobbyScreenState extends State<LobbyScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer3<TicTacItProvider, ThemeProvider, RoomProvider>(
      builder: (context, t, themeProvider, roomProvider, _) {
        return Scaffold(
                  ...
                  children: [
                            ...
                            children: [
                              Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    widget
                                        .roomCode, // Room code to be displayed!!
                                  ...
                                  onPressed: () {
                                    if (kIsWeb) {
                                      FlutterClipboard.copy(
                                        "Tic Tac Toe Online room code is : ${widget.roomCode}, visit and play.\n"
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        roomProvider.userPresencePlayers.length == 2
                            // ? Text(roomProvider.userPresencePlayers[1].username)
                            ? FutureBuilder<Player>(
                                future: roomProvider.getPlayer(
                                  roomProvider
                                      .userPresencePlayers[roomProvider
                                              .isRoomOwner
                                          ? 1
                                          : 0]
                                      .username,
                    ...
                    //             Fluttertoast.showToast(
                    //               msg:
                    //                   "Looks like you're play against yourself",
                    //               toastLength: Toast.LENGTH_LONG,
                    //               gravity: ToastGravity.CENTER,
                    //             );
                    //           } else {
                    ...
                    //         }
                    //       },
                    //       showLoading: widget.roomData.players.length == 2
                    //           ? false
                    //           : true,
                    //     );
                    //   },
