...
class SingleModeScreenState extends State<SingleModeScreen> {
  ...
  void initProvider() {
    Provider.of<SingleModeProvider>(
      context,
      listen: false,
  ...
  Widget build(BuildContext context) {
    SingleModeProvider provider = Provider.of<SingleModeProvider>(
      context,
      listen: true,
    );
                      ...
                      children: [
                        PlayAnimationOnWidget(
                          ...
                          child: PlayerCard(
                            ...
                            showScore: true,
                            scoreValue:
                                provider.scores[PlaySymbol.inNum(
                                  provider.playerChose,
                                )]!,
                          ),
                        ),
                        PlayAnimationOnWidget(
                            ...
                            itemBuilder: (context, index) {
                              return GestureDetector(
                                onTap: () {
                                  ...
                                  if (widget.twoPlayerMode) {
                                    if (provider.board[index] == 0) {
                                      ...
                                      provider.board[index] = PlaySymbol.inNum(
                                        provider.turn,
                                      );
                                      provider.turn =
                                ...
                                child: Container(
                                  decoration: BoxDecoration(
                                    color:
                                        provider.result.positions.contains(
                                          index,
                                        )
                                    ...
                                    borderRadius:
                                        provider.corners.contains(index)
...
class _PlayAnimationOnWidgetState extends State<PlayAnimationOnWidget> {
  @override
  Widget build(BuildContext context) {
    return Consumer<SingleModeProvider>(
      builder: (context, provider, _) {
        return WidgetAnimator(
          ...
          atRestEffect: widget.hasRestEffect
